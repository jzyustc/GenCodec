...
static constexpr int g_y_channels = 256;
static constexpr int g_z_channels = 80;
static constexpr int g_entropy_inner_channels = 128;
static constexpr int g_decoder_body_channels = 96;
static constexpr int g_renderer_channels = 32;
static constexpr int g_renderer_bottleneck_channels = 16;
...
static constexpr int g_num_cond_blocks = 2;
...
public:
    ...
    //   z_i16:         [N, 80, H/64, W/64], contiguous NCHW
    //   compact{0,1}:  [N, H/16, W/16, 128], contiguous NHWC
...
private:
    ...
    Up0Proxy up0_;
    std::array<DiCoBlockProxy, g_num_cond_blocks> blocks_;
