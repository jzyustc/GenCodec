...
static constexpr int INPUT_CHANNELS = 48;
static constexpr int OUTPUT_CHANNELS = 48;
                                ...
                                const at::BFloat16* bias, at::BFloat16* output)
{
    ...
    store_output(acc2, bias + 32, output + 32);
}
...
{
    __m512 acc00 = _mm512_setzero_ps(), acc01 = _mm512_setzero_ps(), acc02 = _mm512_setzero_ps();
    __m512 acc10 = _mm512_setzero_ps(), acc11 = _mm512_setzero_ps(), acc12 = _mm512_setzero_ps();
    __m512 acc20 = _mm512_setzero_ps(), acc21 = _mm512_setzero_ps(), acc22 = _mm512_setzero_ps();
    __m512 acc30 = _mm512_setzero_ps(), acc31 = _mm512_setzero_ps(), acc32 = _mm512_setzero_ps();
    __m512 acc40 = _mm512_setzero_ps(), acc41 = _mm512_setzero_ps(), acc42 = _mm512_setzero_ps();
...
#define STORE_PIXEL(PIXEL)                                             \
    ...
    store_output(acc##PIXEL##2, bias##PIXEL + 32, output##PIXEL + 32)
    STORE_PIXEL(0);
    STORE_PIXEL(1);
    STORE_PIXEL(2);
    STORE_PIXEL(3);
                                                      ...
                                                      const at::Tensor& periodic_bias)
{
    ...
    TORCH_CHECK(periodic_bias.device().is_cpu() && periodic_bias.scalar_type() == at::kBFloat16
                ...
                "periodic_bias must be channels-last CPU BF16 [1, 48, 4, 4]");
