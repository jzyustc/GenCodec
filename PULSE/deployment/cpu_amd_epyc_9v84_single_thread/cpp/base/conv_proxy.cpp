...
at::Tensor DenseConv1x1Bf16::forward_dense_conv1x1_scale_decoder(const at::Tensor& feature,
                                                                 float qp_bias) const
{
    TORCH_CHECK(input_channels_ == 96 && output_channels_ == 5120 && upscale_factor_ == 4
                    && output_chunks_ == 1 && !fuse_silu_ && !fuse_hard_gelu_030_ && !fuse_sigmoid_
                    && bias_.has_value(),
                "scale decoder path requires a plain biased 96->5120 pixel-shuffle convolution");
...
{
    TORCH_CHECK(input_channels_ == 960 && output_channels_ == 128 && upscale_factor_ == 1
                    && output_chunks_ == 1 && !fuse_silu_ && !fuse_hard_gelu_030_ && !fuse_sigmoid_
                    && bias_.has_value(),
                "three-input dense path requires plain biased 960->128 convolution");
    at::Tensor output =
...
{
    TORCH_CHECK(input_channels_ == 48 && output_channels_ == 48 && upscale_factor_ == 1
                    && output_chunks_ == 1 && !fuse_silu_ && !fuse_hard_gelu_030_ && !fuse_sigmoid_
                    && bias_.has_value(),
                "gated residual dense path requires plain biased 48->48 convolution");
                                                                    ...
                                                                    const at::Tensor& periodic_bias) const
{
    TORCH_CHECK(input_channels_ == 48 && output_channels_ == 48 && upscale_factor_ == 1
                    && output_chunks_ == 1 && !fuse_silu_ && !fuse_hard_gelu_030_ && !fuse_sigmoid_
                    && !bias_.has_value(),
                "periodic bias dense path requires plain unbiased 48->48 convolution");
    at::Tensor output =
...
{
    TORCH_CHECK(input_channels_ == 48 && output_channels_ == 144 && upscale_factor_ == 1
                    && output_chunks_ == 3 && !fuse_silu_ && !fuse_hard_gelu_030_ && !fuse_sigmoid_
                    && bias_.has_value(),
                "Ada affine path requires a plain biased 48->144 three-chunk convolution");
...
{
    TORCH_CHECK(input_channels_ == 128 && output_channels_ == 320 && upscale_factor_ == 1
                    && output_chunks_ == 1 && !fuse_silu_ && !fuse_hard_gelu_030_ && !fuse_sigmoid_
                    && bias_.has_value(),
                "spatial reconstruction path requires a plain biased 128->320 convolution");
...
{
    TORCH_CHECK(input_channels_ == 128 && output_channels_ == 640 && upscale_factor_ == 1
                    && output_chunks_ == 2 && !fuse_silu_ && !fuse_hard_gelu_030_ && !fuse_sigmoid_
                    && bias_.has_value(),
                "prior masked-add path requires a plain biased 128->640 two-chunk convolution");
